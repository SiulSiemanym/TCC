...
import Panda3 from "../assets/Imagens/Animais/panda3.jpg"
import GirafaImg2 from "../assets/Imagens/Animais/girafa02.jfif" //muda essa imagem da girafa, krl
import GirafaImg3 from "../assets/Imagens/Animais/girafa01.jfif"
import Arara2 from "../assets/Imagens/Animais/araraazul.webp"
import Arara3 from "../assets/Imagens/Animais/Blue-macaw-bird_1920x1080.jpg"
import Rinoceronte2 from "../assets/Imagens/Animais/rhinoceros.jpg"
import Rinoceronte3 from "../assets/Imagens/Animais/desktop-wallpaper-white-rhinoceros.jpg"
...
export   const animais = [
    ...
    },
    {
      ...
      link: "araraazul",
      imagem: Arara,
      descricao:"Junte-se a nós na missão de preservar as magníficas Araras Azuis! Com sua generosidade, podemos garantir a proteção dessas aves majestosas e seu habitat natural. Cada contribuição faz a diferença, trazendo esperança e oportunidade para um futuro onde as Araras Azuis continuem a voar livres. Faça sua doação hoje e seja parte ativa na conservação dessa espécie única",
      categoria: "animal",
      Metadenome1: "Arara ", Metadenome2: "Azul", Imagem1: Arara, Imagem2: Arara2, Imagem3: Arara3, Populacao: "A população de araras azuis tem diminuído drasticamente, com estimativas indicando que restam cerca de 6.500 indivíduos na natureza. A espécie é considerada 'vulnerável' pela União Internacional para a Conservação da Natureza (UICN), devido à perda de habitat e ao tráfico de animais." , Motivo: "gay", textointrodutorio:"As araras azuis (Anodorhynchus hyacinthinus) são aves grandes e impressionantes, conhecidas por sua plumagem azul vibrante e bico robusto. Nativas das florestas tropicais e áreas de savana da América do Sul, elas são altamente sociáveis e costumam ser vistas em grupos.", Motivo: "A conservação das araras azuis é vital para a biodiversidade dos ecossistemas onde vivem. Elas desempenham um papel importante na dispersão de sementes, ajudando a manter a saúde das florestas. Além disso, são um símbolo da rica fauna brasileira e atraem turistas, o que gera recursos para iniciativas de conservação. Proteger as araras azuis contribui não apenas para a preservação da espécie, mas também para a proteção de seus habitats naturais."
    },
    {
      nome: "Rinocerontes Brancos",
      link: "rinocerontebranco",
      imagem: Rinoceronte,
      descricao:"Juntos, podemos fazer a diferença na proteção dos majestosos Rinocerontes Brancos. Sua doação é fundamental para garantir que essas criaturas incríveis continuem a prosperar em seu habitat natural. Cada contribuição nos aproxima de um futuro onde as gerações futuras possam testemunhar a beleza e a força desses animais. Faça parte desta causa vital e apoie a preservação dos Rinocerontes Brancos hoje mesmo.",
      categoria: "animal",
      Metadenome1: "Rinocerontes ", Metadenome2: "Brancos", Imagem1: Rinoceronte, Imagem2: Rinoceronte2, Imagem3: Rinoceronte3, Populacao: "A população de rinocerontes brancos está gravemente ameaçada, com cerca de 18.000 indivíduos restantes, todos pertencentes à subespécie 'rinoceronte branco do sul'. A subespécie 'rinoceronte branco do norte' está praticamente extinta, com apenas duas fêmeas conhecidas em cativeiro." , Motivo: "gay", textointrodutorio:"As onças-pintadas (Panthera onca) são os maiores felinos das Américas e são conhecidas por sua pelagem dourada com manchas pretas em forma de rosetas. Elas são animais solitários e são excelentes nadadoras, frequentemente encontradas em habitats como florestas tropicais, pantanais e savanas.", Motivo: "Proteger as onças-pintadas é fundamental para a saúde dos ecossistemas em que vivem. Como predadores de topo, elas ajudam a controlar populações de outras espécies, contribuindo para o equilíbrio ecológico. Além disso, as onças são símbolos da rica biodiversidade da América Latina e atraem ecoturismo, o que pode gerar receitas para a conservação. A preservação dessas magníficas criaturas é vital para garantir a integridade dos habitats naturais e a biodiversidade regional." , Motivo: "gay", textointrodutorio:"Os rinocerontes brancos (Ceratotherium simum) são os maiores entre as espécies de rinocerontes, podendo pesar até 2.300 kg. Eles são conhecidos por suas características orelhas grandes e um grande lábio, que utilizam para se alimentar de gramíneas em savanas e pastagens.", Motivo: "A conservação dos rinocerontes brancos é essencial para a biodiversidade e a saúde dos ecossistemas onde habitam. Eles ajudam a moldar o habitat através de sua alimentação, permitindo a diversidade de outras plantas e animais. Além disso, a luta pela sobrevivência dos rinocerontes é emblemática da luta contra o tráfico de animais e a destruição de habitats. Proteger essas majestosas criaturas não só garante a preservação da espécie, mas também promove esforços globais para a conservação da vida selvagem."
    },
    {
      nome: "Onças Pintadas",
      link: "oncapintada",
      ...
      categoria: "animal",    
      Metadenome1: "Onças ", Metadenome2: "Pintadas", Imagem1: Onca, Imagem2: Onca2, Imagem3: Onca3, Populacao: "A população de onças-pintadas é difícil de estimar com precisão, mas acredita-se que existam entre 15.000 e 20.000 indivíduos na natureza. A espécie está classificada como 'quase ameaçada' pela União Internacional para a Conservação da Natureza (UICN) devido à perda de habitat e caça." , Motivo: "gay", textointrodutorio:"Os pinguins As onças-pintadas (Panthera onca) são os maiores felinos das Américas e são conhecidas por sua pelagem dourada com manchas pretas em forma de rosetas. Elas são animais solitários e são excelentes nadadoras, frequentemente encontradas em habitats como florestas tropicais, pantanais e savanas.", Motivo:"Proteger as onças-pintadas é fundamental para a saúde dos ecossistemas em que vivem. Como predadores de topo, elas ajudam a controlar populações de outras espécies, contribuindo para o equilíbrio ecológico. Além disso, as onças são símbolos da rica biodiversidade da América Latina e atraem ecoturismo, o que pode gerar receitas para a conservação. A preservação dessas magníficas criaturas é vital para garantir a integridade dos habitats naturais e a biodiversidade regional."
    },
    {
      nome: "Pinguins Africanos",
      link: "pinguinsafricanos",
      imagem: Pengui,
